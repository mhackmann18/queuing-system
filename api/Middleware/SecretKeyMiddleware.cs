...
public class SecretKeyMiddleware
{
    ...
    {
        _next = next;
        var secretKeyFilePath =
            configuration["SECRET_KEY_FILE_PATH"]
            ?? throw new Exception("SECRET_KEY_FILE_PATH environment variable is missing");
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        if (
            ...
            && context.Request.Path.Equals("/api/v1/users")
        )
        {
